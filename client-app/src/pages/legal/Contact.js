      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group p-10 bg-white/5 border border-white/10 rounded-[3rem] hover:bg-cyan-400/5 hover:border-cyan-400/50 transition-all duration-500">
            ...
            <p className="text-white/50 text-sm mb-6">For payment verification and asset recovery.</p>
          ...
          <div className="p-10 bg-white/5 border border-white/10 rounded-[3rem]">
            ...
            <h3 className="text-2xl font-black uppercase mb-4 italic">Response Time</h3>
            <p className="text-white/50 text-sm">Our agents are active 10:00 AM - 08:00 PM IST. Average response: 4 Hours.</p>
          </div>
          ...
          <div className="p-10 bg-white/5 border border-white/10 rounded-[3rem]">
            ...
            <p className="text-white/50 text-sm italic uppercase font-bold tracking-widest">Bengaluru, India</p>
          </div>
        </div>
      </div>
    </motion.div>
